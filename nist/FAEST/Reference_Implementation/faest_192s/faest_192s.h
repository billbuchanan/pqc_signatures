...
#define FAEST_192S_PRIVATE_KEY_SIZE 24
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_192s_sign(const uint8_t* sk, const uint8_t* pk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
