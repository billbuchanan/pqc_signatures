...
#define CRYPTO_PUBLICKEYBYTES   47072
#define CRYPTO_SECRETKEYBYTES   301568
#define CRYPTO_BYTES            120
#define CRYPTO_ALGNAME          "FOX-128"
#endif

#ifdef PARAM_SET_FULLVOX192
#define CRYPTO_PUBLICKEYBYTES   211172
#define CRYPTO_SECRETKEYBYTES   1341938
#define CRYPTO_BYTES            261
#define CRYPTO_ALGNAME          "FOX-192"
#endif

#ifdef PARAM_SET_FULLVOX256
#define CRYPTO_PUBLICKEYBYTES   694908
#define CRYPTO_SECRETKEYBYTES   4182124
#define CRYPTO_BYTES            462
#define CRYPTO_ALGNAME          "FOX-256"
#endif
