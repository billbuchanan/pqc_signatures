...
#define SIGN_MIRA_256_SIGNATURE_BYTES 27732         /**< Signature size */
...
#define SIGN_MIRA_256_PARAM_N_MPC 32                /**< Parameter N of the scheme (number of parties) */
#define SIGN_MIRA_256_PARAM_N_MPC_LOG2 5            /**< Log2 of parameter N */
#define SIGN_MIRA_256_PARAM_D 5                     /**< Parameter D of the scheme (number of main parties) */
#define SIGN_MIRA_256_PARAM_TAU 54                  /**< Parameter tau of the scheme (number of iterations) */
...
#define SIGN_MIRA_256_PARAM_TREE_LEAF_BYTES 1024    /**< Number of bytes required to store the leaf of the seed tree */
#define SIGN_MIRA_256_PARAM_TREE_PATH_BYTES 160     /**< Number of bytes required to store the authentication path of the seed tree */
#define SIGN_MIRA_256_PARAM_COMMITMENT_BYTES 2048   /**< Number of bytes required to store the commitments */
#define SIGN_MIRA_256_PARAM_STATE_BYTES 217         /**< Number of bytes required to store the state of party N */
#define SIGN_MIRA_256_PARAM_RESPONSE_BYTES 510      /**< Number of bytes required to store the response of a given iteration */
