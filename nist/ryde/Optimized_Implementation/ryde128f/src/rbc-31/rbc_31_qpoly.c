/** 
 * \file rbc_31_qpoly.c
 * \brief Implementation of rbc_31_qpoly.h
 *
...
/** 
 * \fn void rbc_31_qpoly_init(rbc_31_qpoly* p, int32_t max_degree)
...
void rbc_31_qpoly_init(rbc_31_qpoly* p, int32_t max_degree) {
  *p = malloc(sizeof(rbc_31_qpoly_struct));

  rbc_31_vec_init(&((*p)->values), max_degree + 1);
...
/** 
 * \fn void rbc_31_qpoly_update_degree(rbc_31_qpoly p, int32_t position)
 * \brief This function updates the degree of a rbc_31_qpoly starting from a given position.
 *
...
void rbc_31_qpoly_update_degree(rbc_31_qpoly p, int32_t position) {
  for(int32_t i = position ; i >= 0 ; --i) {
    if(rbc_31_elt_is_zero(p->values[i]) == 0) { 
      p->degree = i;
      return;
    }
  }
...
/** 
 * \fn int8_t rbc_31_qpoly_set_zero(rbc_31_qpoly o)
...
int8_t rbc_31_qpoly_set_zero(rbc_31_qpoly o) {
  o->degree = -1;
  rbc_31_vec_set_zero(o->values, o->max_degree + 1);
...
/** 
 * \fn int8_t rbc_31_qpoly_set_one(rbc_31_qpoly o)
...
int8_t rbc_31_qpoly_set_one(rbc_31_qpoly o) {
  o->degree = 0;
  rbc_31_elt_set_one(o->values[0]);

  for(int32_t i = 1 ; i < o->max_degree + 1 ; ++i) {
    rbc_31_elt_set_zero(o->values[i]);
  }
...
/**
 * \fn int8_t rbc_31_qpoly_annulator(rbc_31_qpoly p, const rbc_31_vec v, uint32_t size)
...
int8_t rbc_31_qpoly_annihilator(rbc_31_qpoly p, const rbc_31_vec v, int32_t size) {
  ...
  rbc_31_elt p_at_vi;
  rbc_31_qpoly t;
  rbc_31_qpoly_init(&t, size);
  rbc_31_qpoly_set_zero(t);

  // We initialise p as x
  rbc_31_qpoly_set_one(p);

  int i;
  for(i = 0; i < size; ++i) {
    rbc_31_qpoly_evaluate(p_at_vi, p, v[i]);   // p_i(v_i)
    rbc_31_qpoly_qexp(t, p);                   // (p_i^q)(x)
    rbc_31_qpoly_scalar_mul(p, p, p_at_vi);    // (p_i(v_i) * p_i)(x)
    rbc_31_qpoly_add(p, p, t);                 // (p_i^q + p_i(v_i) * p_i)(x)
  }

  rbc_31_elt_set_zero(p_at_vi);
  rbc_31_qpoly_clear(t);
...
/** 
 * \fn void rbc_31_qpoly_evaluate(rbc_31_elt o, const rbc_31_qpoly p, const rbc_31_elt e)
...
void rbc_31_qpoly_evaluate(rbc_31_elt o, const rbc_31_qpoly p, const rbc_31_elt e) {
  rbc_31_elt tmp1, tmp2;

  rbc_31_elt_set(tmp1, e);
  rbc_31_elt_mul(o, p->values[0], tmp1);

  for(int32_t i = 1 ; i <= p->degree ; ++i) {
    rbc_31_elt_sqr(tmp1, tmp1);
    rbc_31_elt_mul(tmp2, p->values[i], tmp1);
    rbc_31_elt_add(o, o, tmp2);
  }
}
...
/** 
 * \fn int8_t rbc_31_qpoly_scalar_mul(rbc_31_qpoly o, const rbc_31_qpoly p, const rbc_31_elt e)
...
int8_t rbc_31_qpoly_scalar_mul(rbc_31_qpoly o, const rbc_31_qpoly p, const rbc_31_elt e) {
  ...
  for(int32_t i = 0 ; i <= p->degree ; ++i) {
    rbc_31_elt_mul(tmp, p->values[i], e);
    rbc_31_elt_set(o->values[i], tmp);
  }
...
/** 
 * \fn int8_t rbc_31_qpoly_qexp(rbc_31_qpoly o, const rbc_31_qpoly p)
...
int8_t rbc_31_qpoly_qexp(rbc_31_qpoly o, const rbc_31_qpoly p) {
  ...
  rbc_31_elt tmp;
  rbc_31_elt_set_zero(o->values[0]);
  for(int32_t i = 0 ; i <= p->degree ; ++i) {
    rbc_31_elt_sqr(tmp, p->values[i]);
    rbc_31_elt_set(o->values[(i + 1) % RBC_31_FIELD_M], tmp);
  }
  ...
  rbc_31_qpoly_update_degree(o, p->degree + 1);
...
/** 
 * \fn int8_t rbc_31_qpoly_add(rbc_31_qpoly o, const rbc_31_qpoly p1, const rbc_31_qpoly p2)
...
int8_t rbc_31_qpoly_add(rbc_31_qpoly o, const rbc_31_qpoly p1, const rbc_31_qpoly p2) {
  ...
  for(int32_t i = 0 ; i <= o->degree ; ++i) {
    rbc_31_elt_add(o->values[i], p1->values[i], p2->values[i]);
  }
  ...
  rbc_31_qpoly_update_degree(o, o->degree);
