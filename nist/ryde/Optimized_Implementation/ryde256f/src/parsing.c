...
/**
 * \fn void ryde_256f_public_key_to_string(uint8_t* pk, const uint8_t* pk_seed, const rbc_43_vec y)
...
void ryde_256f_public_key_to_string(uint8_t* pk, const uint8_t* pk_seed, const rbc_43_vec y) {
  memcpy(pk, pk_seed, RYDE_256F_SECURITY_BYTES);
  rbc_43_vec_to_string(&pk[RYDE_256F_SECURITY_BYTES], y, RYDE_256F_PARAM_N - RYDE_256F_PARAM_K);
}



/**
 * \fn void ryde_256f_public_key_from_string(rbc_43_mat H, rbc_43_vec y, const uint8_t* pk)
...
void ryde_256f_public_key_from_string(rbc_43_mat H, rbc_43_vec y, const uint8_t* pk) {
  ...
  memcpy(pk_seed, pk, RYDE_256F_SECURITY_BYTES);
  ...
  // Compute syndrome
  rbc_43_vec_from_string(y, RYDE_256F_PARAM_N - RYDE_256F_PARAM_K, &pk[RYDE_256F_SECURITY_BYTES]);
...
/**
 * \fn void ryde_256f_secret_key_to_string(uint8_t* sk, const uint8_t* seed, const uint8_t* pk)
 ...
 * \param[in] pk String containing the public key
 */
void ryde_256f_secret_key_to_string(uint8_t* sk, const uint8_t* sk_seed, const uint8_t* pk) {
  memcpy(sk, sk_seed, RYDE_256F_SECURITY_BYTES);
  memcpy(&sk[RYDE_256F_SECURITY_BYTES], pk, RYDE_256F_SECURITY_BYTES);
}



/**
* \fn void ryde_256f_secret_key_from_string(rbc_43_vec y, rbc_43_mat H, rbc_43_vec x1, rbc_43_vec x2, rbc_43_qpoly A, const uint8_t* sk)
...
void ryde_256f_secret_key_from_string(rbc_43_vec y, rbc_43_mat H, rbc_43_vec x1, rbc_43_vec x2, rbc_43_qpoly A, const uint8_t* sk) {
  ...
  memcpy(sk_seed, sk, RYDE_256F_SECURITY_BYTES);
  ...
  rbc_43_qpoly_annihilator(A, support, RYDE_256F_PARAM_W);

  // Compute public key
  memcpy(pk_seed, &sk[RYDE_256F_SECURITY_BYTES], RYDE_256F_SECURITY_BYTES);
  seedexpander_shake_init(&pk_seedexpander, pk_seed, RYDE_256F_SECURITY_BYTES, NULL, 0);
