...
| EagleSign                    | X                                       | X                                             | X                             | X                              | Y                   | The NIST API files differed enough that special cases needed to be added for parameter definitions and AES256ctr source code files were not present and had to be included to compile correclty |
| HAETAE                       |                                         |                                               |                               |                                | N                   |                                                                                                                                                                                                 |
| KAZ_SIGN                     |                                         |                                               |                               |                                | N                   |                                                                                                                                                                                                 |
| LESS                         |                                         |                                               |                               |                                | N                   |                                                                                                                                                                                                 |
| MiRitH                       |                                         |                                               |                               |                                | N                   |                                                                                                                                                                                                 |
