...
*  Xifrat Signature. [Xifrat Signature](https://asecuritysite.com/pqc/xifrat_sign). The Xifrat Signature uses a randomly generated abelian quasigroup of 16 elements. It uses three layers of large abelian quasigroups, and which increase in their size. An abelian group - named after Niels Henrik Abel - involves a group where it does not matter the order in which an operation is applied - and is thus communative. For addition, a+b or b+a will give the same result. .group operation is commutative. 
