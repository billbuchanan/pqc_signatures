...
(refer to marked for team debugging)
...
| Wave                         | X                                       | X                                             | X                             |                                | N                   | The pqcsign binary is able to compile, is able to perform key generation/signing operations, but an error occurs when verifying the signature. This algorithm has been added to the dev_seutp.sh script for team debugging.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
