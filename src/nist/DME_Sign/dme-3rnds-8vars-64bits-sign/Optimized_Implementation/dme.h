...
#define fq_0   UINT64_C(0x0000000000000000)
#define fq_1   UINT64_C(0x0000000000000001)
#define fq_t   UINT64_C(0x0000000000000002)
#define fq_t64 UINT64_C(0x0000000000000807)  /* Fq = F2[t]/<t^64+t^11+t^2+t+1> */
#define fq_qm1 UINT64_C(0xffffffffffffffff)
#define fq_qm2 UINT64_C(0xfffffffffffffffe)
...
#define SKEY_BYTES (4*4*2*2*8+16*4*3+6+6+5)
#define PKEY_BYTES ((65+25+25+65)*16+9)
