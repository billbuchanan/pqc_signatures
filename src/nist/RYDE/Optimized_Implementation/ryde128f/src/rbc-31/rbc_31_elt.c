...
void rbc_31_elt_ur_mul(rbc_31_elt_ur o, const rbc_31_elt e1, const rbc_31_elt e2) {
  ...
  _mm_storeu_si64((uint64_t*) o, a0_b0);
}
...
void rbc_31_elt_ur_sqr(rbc_31_elt_ur o, const rbc_31_elt e) {
  ...
  e_l = _mm_and_si128(tmp, RBC_31_ELT_SQR_MASK_128);
  e_h = _mm_and_si128(_mm_srli_epi64(tmp, 4), RBC_31_ELT_SQR_MASK_128);

  e_l = _mm_shuffle_epi8(RBC_31_ELT_SQR_LOOKUP_TABLE_128, e_l);
  e_h = _mm_shuffle_epi8(RBC_31_ELT_SQR_LOOKUP_TABLE_128, e_h);

  tmp = _mm_unpacklo_epi8(e_l, e_h);
  _mm_storeu_si64((uint64_t*) o, tmp);
}
