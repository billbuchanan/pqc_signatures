...
int crypto_sign_keypair(
	...
	uint8_t seed_A_hat[PARAM_SEED_BYTES];
	shake128(seed_A_hat, PARAM_SEED_BYTES, randomness, PARAM_SEED_BYTES);
	int16_t A_hat[PARAM_M * PARAM_N];
	gen_mat(A_hat, PARAM_M * PARAM_N, seed_A_hat, PARAM_SEED_BYTES);
	...
	// pack pk
	memcpy(pk, seed_A_hat, PARAM_SEED_BYTES);
	memcpy(pk + PARAM_SEED_BYTES, B, PARAM_M * PARAM_M * sizeof(int16_t));
...
int crypto_sign(
	...
	uint8_t seed_A_hat[PARAM_SEED_BYTES];
	memcpy(seed_A_hat, pk, PARAM_SEED_BYTES);
	int16_t A_hat[PARAM_M * PARAM_N];
	gen_mat(A_hat, PARAM_M * PARAM_N, seed_A_hat, PARAM_SEED_BYTES);
