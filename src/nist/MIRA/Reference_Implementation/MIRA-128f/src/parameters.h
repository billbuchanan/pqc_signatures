...
#define SIGN_MIRA_128_SIGNATURE_BYTES 7376          /**< Signature size */
...
#define SIGN_MIRA_128_PARAM_N_MPC 32                /**< Parameter N of the scheme (number of parties) */
#define SIGN_MIRA_128_PARAM_N_MPC_LOG2 5            /**< Log2 of parameter N */
#define SIGN_MIRA_128_PARAM_D 5                     /**< Parameter D of the scheme (number of main parties) */
#define SIGN_MIRA_128_PARAM_TAU 28                  /**< Parameter tau of the scheme (number of iterations) */
...
#define SIGN_MIRA_128_PARAM_TREE_LEAF_BYTES 512     /**< Number of bytes required to store the leaf of the seed tree */
#define SIGN_MIRA_128_PARAM_TREE_PATH_BYTES 80      /**< Number of bytes required to store the authentication path of the seed tree */
#define SIGN_MIRA_128_PARAM_COMMITMENT_BYTES 1024   /**< Number of bytes required to store the commitments */
#define SIGN_MIRA_128_PARAM_STATE_BYTES 108         /**< Number of bytes required to store the state of party N */
#define SIGN_MIRA_128_PARAM_RESPONSE_BYTES 260      /**< Number of bytes required to store the response of a given iteration */
