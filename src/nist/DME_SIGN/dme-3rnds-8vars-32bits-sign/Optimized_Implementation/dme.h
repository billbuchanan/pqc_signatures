...
typedef uint32_t fq_elem;
typedef uint32_t fq_expn;

#define fq_0   UINT32_C(0x00000000)
#define fq_1   UINT32_C(0x00000001)
#define fq_t   UINT32_C(0x00000002)
#define fq_t32 UINT32_C(0x00000813)  /* Fq = F2[t]/<t^32+t^11+t^4+t+1> */
#define fq_qm1 UINT32_C(0xffffffff)
#define fq_qm2 UINT32_C(0xfffffffe)
...
#define SKEY_BYTES (4*4*2*2*4+8*4*3+6+6+5)
#define PKEY_BYTES ((65+25+25+65)*8+9)
