/** 
 * @file sign_mira_256_mpc.h
 * @brief Functions concerning the MPC part of the SIGN_MARS_CODE scheme
 */

#ifndef SIGN_MIRA_256_MPC_H
#define SIGN_MIRA_256_MPC_H
...
typedef struct {
    gf16_mat x[SIGN_MIRA_256_PARAM_N_MPC];
    gfqm_vec beta[SIGN_MIRA_256_PARAM_N_MPC];
    gfqm_vec a[SIGN_MIRA_256_PARAM_N_MPC];
    gfqm c[SIGN_MIRA_256_PARAM_N_MPC];
    gfqm_vec a_;
} sign_mira_256_shares_t;
...
typedef struct {
    ...
    gfqm_vec a[SIGN_MIRA_256_PARAM_N_MPC];
    gfqm c[SIGN_MIRA_256_PARAM_N_MPC];
} sign_mira_256_main_shares_t;

typedef struct {
    gfqm_vec gamma;
    gfqm epsilon;
} sign_mira_256_challenge1_t;

typedef struct {
    gfqm_vec alpha_;
    gfqm_vec alpha[SIGN_MIRA_256_PARAM_D];
    gfqm v[SIGN_MIRA_256_PARAM_D];
} sign_mira_256_response1_t;


void sign_mira_256_init_shares(sign_mira_256_shares_t *shares);
void sign_mira_256_init_main_shares(sign_mira_256_main_shares_t *parties);
...
void sign_mira_256_clear_main_shares(sign_mira_256_main_shares_t *parties);
...
void sign_mira_256_commit_to_shares(uint8_t *commits, uint8_t e, const uint8_t *salt, const sign_mira_256_shares_t *shares, const uint8_t *seed_input);
void sign_mira_256_compute_main_shares(sign_mira_256_main_shares_t *parties, const sign_mira_256_shares_t *shares);
...
void sign_mira_256_recompute_commitments(uint8_t *commits, uint8_t *seed_inputs, uint8_t e, const uint8_t *salt, const uint8_t *state, uint8_t hidden);
void sign_mira_256_recompute_shares(sign_mira_256_shares_t *shares, const uint8_t *seed_input, const uint8_t *state, uint8_t second_challenge, const uint8_t *salt);
void sign_mira_256_recompute_main_shares(sign_mira_256_main_shares_t *parties, const sign_mira_256_shares_t *shares, uint8_t second_challenge);
