...
#define SIGN_MIRA_192_SIGNATURE_BYTES 11792         /**< Signature size */
...
#define SIGN_MIRA_192_PARAM_N_MPC 256               /**< Parameter N of the scheme (number of parties) */
#define SIGN_MIRA_192_PARAM_N_MPC_LOG2 8            /**< Log2 of parameter N */
#define SIGN_MIRA_192_PARAM_D 8                     /**< Parameter D of the scheme (number of main parties) */
#define SIGN_MIRA_192_PARAM_TAU 26                  /**< Parameter tau of the scheme (number of iterations) */
...
#define SIGN_MIRA_192_PARAM_TREE_LEAF_BYTES 6144    /**< Number of bytes required to store the leaf of the seed tree */
#define SIGN_MIRA_192_PARAM_TREE_PATH_BYTES 192     /**< Number of bytes required to store the authentication path of the seed tree */
#define SIGN_MIRA_192_PARAM_COMMITMENT_BYTES 12288  /**< Number of bytes required to store the commitments */
#define SIGN_MIRA_192_PARAM_STATE_BYTES 151         /**< Number of bytes required to store the state of party N */
#define SIGN_MIRA_192_PARAM_RESPONSE_BYTES 448      /**< Number of bytes required to store the response of a given iteration */
