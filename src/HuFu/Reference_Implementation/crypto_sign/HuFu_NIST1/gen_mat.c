...
void gen_mat_aes256(int16_t * data, int data_len, uint8_t * m, int m_len){
...
void gen_mat_shake256(int16_t * data, int data_len, uint8_t * m, int m_len){
	uint8_t *t;
        t = malloc(m_len+1);
        memcpy(t+1, m, m_len);
...
void gen_mat(int16_t * data, int data_len, uint8_t * m, int m_len){        
