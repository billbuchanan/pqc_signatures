...
function clear_env_vars(){
    # Function for clearing the environment variables after they have been loaded into the calling script
...
function create_alg_arrays() {
    ...
    # Create the algorithm variation arrays
